...
// Toggle for decorative "extra elements". OFF → strict regeneration from
    ...
    <button
      ...
      title={
        value
          ...
          : "Extra elements OFF — the banner is regenerated strictly from your request, with no extra decoration."
      }
      className={cn(
